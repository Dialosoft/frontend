...
export default function Notify_Template({ name, type, time, link }: NotifyProps) {
	...
	return (
		<Link className="inline-block w-full px-2 py-1 hover:bg-black-300 hover:bg-opacity-25 rounded-md" title={fullText} href={link} prefetch={false}>
			<div className="flex items-center justify-between">
				<div className="flex items-center space-x-[.5rem] overflow-hidden">
					<div className="w-8 h-8 flex-shrink-0 rounded-full border border-primary-400"></div>
