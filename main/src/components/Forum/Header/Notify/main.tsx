...
export default function Notify({ notifyTemplate, clearNotifications }: NotificationsProps) {
	return (
		<div className="absolute overflow-hidden w-80 lg:w-96 top-full mt-[1rem] right-0 rounded-lg z-50 bg-black-700 border border-opacity-25 border-black-300 text-black-500">
