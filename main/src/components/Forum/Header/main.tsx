				...
				<div>
					{session ? (
						...
						<div className="flex items-center space-x-[.5rem]">
							<Link href="/login">
								<button className="bg-black-300 py-[.5rem] px-[1rem] rounded-md transition-transform ease-in-out duration-300 hover:scale-105 select-none font-medium">
									Login
								</button>
							</Link>
