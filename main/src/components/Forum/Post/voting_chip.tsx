...
export default function PostVotingChip() {
	const arrowsStyle = "bg-opacity-25 text-black-500 bg-black-500 rounded-full size-8 px-1 cursor-pointer hover:bg-opacity-40 hover:text-secondary transition-colors";
