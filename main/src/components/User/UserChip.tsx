...
export default function UserChip({highlighted}:UserChipProps) {
  return (
	<div className='flex gap-3 items-center'>
		<img src={"https://flussen.dev/me.webp"} alt={""} className={`${ highlighted ? "border-primary-500" : "border-secondary"} h-12 w-12 rounded-full border-white border-2 border-solid`} />
		<div>
