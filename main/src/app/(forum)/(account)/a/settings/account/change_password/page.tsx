...
export default function StgsChangePass() {
  ...
  <label className={tw_label}>Actual Password</label>
                            ...
                            <input
                                ...
                                className={`w-full appearance-none placeholder:font-light placeholder:text-sm focus:outline-none bg-black-300 bg-opacity-25 border border-black-300 rounded-md  px-[.6rem] py-[.4rem]`}
                                required
                            />
